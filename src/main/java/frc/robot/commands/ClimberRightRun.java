...
public class ClimberRightRun extends Command {
  private final Climber_Right_Subsystem m_subsystem;
  private DoubleSupplier m_speed;
  /** Creates a new ClimberLeftRun. */
  public ClimberRightRun(DoubleSupplier speed, Climber_Right_Subsystem subsystem) {
    m_speed = speed;
